...
let
  sources = {
    "@aws-cdk/cfnspec-1.91.0" = {
      ...
      version = "1.91.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@aws-cdk/cfnspec/-/cfnspec-1.91.0.tgz";
        sha512 = "DQ4uxcq86p+IzI0G94NjTyzMU5/6FqQFRtl33b/WpdscBQgi1pmcMLWEB+EnV6sGxDcEx3eDQAHUgW5JVgx9Xg==";
      };
    };
    "@aws-cdk/cloud-assembly-schema-1.91.0" = {
      ...
      version = "1.91.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@aws-cdk/cloud-assembly-schema/-/cloud-assembly-schema-1.91.0.tgz";
        sha512 = "gauXsfersDNDHdszDIbSkM2UG/xZmfLqurzw5aqYWFPmPML5a8Izx5hhjwnTKBO5+gQeQxiv9Zc4q5vBI1ScLQ==";
      };
    };
    "@aws-cdk/cloudformation-diff-1.91.0" = {
      ...
      version = "1.91.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@aws-cdk/cloudformation-diff/-/cloudformation-diff-1.91.0.tgz";
        sha512 = "JSm8p96+3mhluwFP+kcqmqHAHELrClEIKcDPcBmsurUkkg1+84yoWYUg5nFMFJCKeTL5E5q7ugUqswYuvxgbSw==";
      };
    };
    "@aws-cdk/cx-api-1.91.0" = {
      ...
      version = "1.91.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@aws-cdk/cx-api/-/cx-api-1.91.0.tgz";
        sha512 = "5IDKq+R8BANrq2SCRLF6FJLZUNCDW8WWhs8hrCNZ8tOGlmxu1+whffTwVDj7Mb+aLb5+KlhavAhUYRaS2Ex7cA==";
      };
    };
    "@aws-cdk/region-info-1.91.0" = {
      ...
      version = "1.91.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@aws-cdk/region-info/-/region-info-1.91.0.tgz";
        sha512 = "/iYYx5BDHfOeKO6yOW2+oNOZ9Cd3K8kmPJsX6b7WgOt69w6hK4GrnaV5c4a/nQ5N5AMwwDNTnRhlvm94nH9gLA==";
      };
    };
    "@aws-cdk/yaml-cfn-1.91.0" = {
      ...
      version = "1.91.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/@aws-cdk/yaml-cfn/-/yaml-cfn-1.91.0.tgz";
        sha512 = "TR0PBDN1Wm93mkavIUPTU7mkyGQHhepVQNfAX+GcDX34PiBY7rkjyWkN/1S5YdRmb3bHcIhtCXS8mEF87EnGDw==";
      };
    };
    ...
    "aws-sdk-2.853.0" = {
      ...
      version = "2.853.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/aws-sdk/-/aws-sdk-2.853.0.tgz";
        sha512 = "3cifeifeMHKtpvQ6OcrA9j34BEdvWmLlSGzZU/mZf9nYcV+22PPXjwpVhPh9BvfC2S77upKNbMgnkv4u50aQKw==";
      };
    };
    ...
    "cdk-assets-1.91.0" = {
      ...
      version = "1.91.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/cdk-assets/-/cdk-assets-1.91.0.tgz";
        sha512 = "LTl3yGHNFIMOtsA9z8vI9UXJ86n10FqELKW9mMcJj6Ce5xfOcHAocMnoPIIr9V77bmfcbBBLWBwY9N4gAMPpow==";
      };
    };
    "charenc-0.0.2" = {
      name = "charenc";
...
in
{
  aws-cdk = nodeEnv.buildNodePackage {
    ...
    src = fetchurl {
      ...
      sha512 = "CkYR+INbzna9DeYqoiAaRcrfqvUubQw+cuCi41qk9tuVQIss85Bxx/7WJCtkoieqO9AaJLouiN8xTSLAFOL/zA==";
    };
    dependencies = [
      sources."@aws-cdk/cfnspec-1.91.0"
      sources."@aws-cdk/cloud-assembly-schema-1.91.0"
      sources."@aws-cdk/cloudformation-diff-1.91.0"
      sources."@aws-cdk/cx-api-1.91.0"
      sources."@aws-cdk/region-info-1.91.0"
      sources."@aws-cdk/yaml-cfn-1.91.0"
